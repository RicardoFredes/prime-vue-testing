export default {
    root: ({ props, context, parent }) => ({
        class: [
            ...
            // Link Button
            { 'text-primary-600 bg-transparent ring-transparent hover:bg-transparent px-0': props.link },
    ...
    label: ({ props }) => ({
        class: [
            ...
            { 'flex-1': props.label !== null, 'invisible w-0': props.label == null || props.loading }
        ]
    }),
    icon: ({ props }) => ({
        class: [
