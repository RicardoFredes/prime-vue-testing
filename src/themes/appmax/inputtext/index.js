    ...
    root: ({ props, context, parent }) => ({
        class: [
            ...
            'm-0',
            {
                ...
                'py-2 px-3 sm:text-sm': !props.size || props.size == 'medium'
            },
            ...
            'bg-transparent border-surface-900',
            // 'shadow-sm',
            { 'ring-1 ring-inset ring-surface-700 dark:ring-surface-700 ring-offset-0': parent.instance.$name !== 'InputGroup' },
